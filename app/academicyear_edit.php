...
if (isset($_SERVER['PHP_SELF'])) {
    if (isset($_POST['update'])) {
       if ($academicyear->academicyear_update($_POST) == 1) {
           header('location: academicyear.php');
       }else{
            $message = 'Theres a problem updating academic year. Please try again';
       }
    }
}else{
    unset($message);
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span>Edit academic year form</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                    <input type="text" name="id" hidden="" value="<?php echo $academic_info['id']; ?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="name">Name</label> <span class="text-danger">*</span>
                                                <input type="text" class="form-control" id="name" placeholder="year-year" name="name" required="" value="<?php echo $academic_info['name']; ?>">
                                            </div>
                                        </div>                                     
                                        <div class="col-md-6">
                                            <div class="form-group">
