...
if (isset($_SERVER['PHP_SELF'])) {
    if (isset($_POST['save'])) {
       if ($departments->department_add($_POST)) {
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                    <div class="row">                                        
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="departmentname" placeholder="Department Name" name="departmentname">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="departmenthead">Department Head</label>
                                                <input type="text" class="form-control" id="departmenthead" placeholder="Department Head" name="departmenthead">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                    ...
                                    <button class="btn btn-success float-right" name="save" type="submit"><i class="ik ik-save"></i>Save</button>
                                </form>
                            </div>
                        </div>
                    </div>
